...
@Component({
  selector: 'app-crearemp',
  templateUrl: './crearemp.component.html',
  styleUrls: ['./crearemp.component.scss']
})
export class CrearempComponent {
  ...
  submitForm() {
    ...
    const url = 'http://localhost:8080/api/saveemp'; // Reemplaza con la URL de tu servidor Spring
