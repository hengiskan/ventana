...
@Component({
  selector: 'app-creardep',
  templateUrl: './creardep.component.html',
  styleUrls: ['./creardep.component.scss']
})
export class CreardepComponent {
  formData: any = {};
  chec: boolean = false;
  ...
  submitForm() {
    ...
    const url = 'http://localhost:8080/api/savedep'; // Reemplaza con la URL de tu servidor Spring
