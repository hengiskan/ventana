...
@Component({
  selector: 'app-editemplo',
  templateUrl: './editemplo.component.html',
  styleUrls: ['./editemplo.component.scss']
})
export class EditemploComponent {
  tabvisible=false;
  formData: any = {};
  chec: boolean = false;
  selec:any={};
  public respvec: any[]=[];
  baseUrl = 'http://localhost:8080/api/upemplo/';
